...
class KPIItemBean {
  ...
  set set_time_jiaofu(value) => dialogList[0][0].value = time_jiaofu;

  set set_time_baohe(value) => dialogList[0][1].value = time_jiaofu;

  set set_quality_bug(value) => dialogList[1][0].value = time_jiaofu;

  set set_quality_diff(value) => dialogList[1][1].value = time_jiaofu;

  set set_attitude_person(value) => dialogList[2][0].value = time_jiaofu;

  set set_attitude_team(value) => dialogList[2][1].value = time_jiaofu;
