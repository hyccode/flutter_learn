...
abstract class BaseLoadingPageState<T extends StatefulWidget>
    extends BaseKeepAlivePageState<T> implements ILoadingView {
...
/// 如果不想 keep alive 要 重写 bool get wantKeepAlive => false;
abstract class BaseLoadingListPageState<T extends StatefulWidget>
    extends BaseKeepAlivePageState<T> implements ILoadingListView {
  bool _isPrepared = false;
